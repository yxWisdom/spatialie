...
//        List<String> test_lines = lines.subList(pos, lines.size());
        ...
        FileUtil.writeFile(out_dir+"/dev_all.txt", test_lines, false);
...
//    }
    ...
    private static void partitionCorpus(String dirPath, double proportion, List<String> data) {
        ...
        FileUtil.writeFile(dirPath + "/dev_all.txt", test_data, false);
...
//        linkGroupMap.forEach((k,v)->linkGroupMap.get("ALL").addAll(v));
        ...
        for (String type: types) {
            ...
            if (partition) {
                ...
                FileUtil.writeFile(path + "/" + "dev_all.txt", test_lines);
...
//        for (int i=)
    ...
    public static void generateFinalNerCorpus() {
        ...
        GenerateCorpus.removeSpatialEntity("data/processed_data/msra/ner/joint_random/dev_all.txt",
                "data/processed_data/msra/ner/joint_random/train.txt", "line");

        GenerateCorpus.removeSpatialEntity("data/processed_data/msra/ner/random/dev_all.txt",
        ...
        FileUtil.mergeFile("data/processed_data/msra/ner/random/dev_all.txt", "data/processed_data/ner_final/random/dev_all.txt");
        FileUtil.mergeFile("data/processed_data/msra/ner/random/dev_all.txt", "data/processed_data/ner_final/random/test.txt");
        ...
        FileUtil.mergeFile("data/processed_data/msra/ner/joint_random/dev_all.txt", "data/processed_data/ner_final/joint_random/dev_all.txt");
        FileUtil.mergeFile("data/processed_data/msra/ner/joint_random/dev_all.txt", "data/processed_data/ner_final/joint_random/test.txt");
...
//        GenerateCorpus.generateCorpus("data/annotation/msra", "data/processed_data/ner_v3/joint/dev_all.txt",
...
//        GenerateCorpus.generateCorpus("data/annotation/msra", "data/processed_data/ner_v3/normal/dev_all.txt",
...
//        GenerateCorpus.filterMLINK("data/processed_data/srl_link/with_conj/TOMLINK/dev_all.txt");
...
//        GenerateCorpus.filterMLINK("data/processed_data/srl_link/without_conj/TOMLINK/dev_all.txt");
