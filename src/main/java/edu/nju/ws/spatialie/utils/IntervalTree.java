...
//            System.out.println(intervalList.size());
    ...
    public boolean overlap(long start, long end) {
        return get(start, end).size() > 0;
    }
}

class IntervalTreeProblem
{
...
//        it.addInterval(25L, 35L, 4);
        ...
        it.addInterval(0L, 20L, 1);
        it.addInterval(20L, 40L, 2);
        it.addInterval(40L, 80L, 3);
        it.addInterval(80L, 100L, 4);




        System.out.println(it.get(0,20));
        System.out.println(it.get(0,19));
        System.out.println(it.get(1,18));
        System.out.println(it.get(0,21));
        System.out.println(it.get(0,21));
        System.out.println(it.get(100,101));





        it.addInterval(5L, 10L, 5);
        System.out.println(it.toString());

        it.addInterval(5L, 25L, 6);
        System.out.println(it.toString());

        System.out.println(it.get(0,101));
